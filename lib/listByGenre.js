...
module.exports = function(genreSort){
  return knex('books').where({genre: genreSort}).orderBy('id').then(function(books){
    return knex('books').where({genre: genreSort}).count('id').then(function(count){
